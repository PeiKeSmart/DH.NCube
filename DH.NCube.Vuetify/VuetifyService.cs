...
namespace NewLife.Cube.Vuetify;

/// <summary>Vuetify前端皮肤服务</summary>
public static class VuetifyService
{
    /// <summary>使用Vuetify前端皮肤。替换WebRootFileProvider以注册嵌入式静态资源，并添加SPA回退路由，提供Vue3+Vuetify 3管理后台前端</summary>
...
/// <summary>Vuetify前端皮肤模块</summary>
[DisplayName("Vuetify前端皮肤")]
internal class VuetifyModule : IModule
{
